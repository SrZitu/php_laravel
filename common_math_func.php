...
echo PHP_EOL;
// mt_rand() - Returns a random number using the Mersenne Twister random number generator. 
//This function generates a better random number than the rand() function.
$max = 100;
