...
function isFactorial(int $x){ //type hinting
...
function serve($foodType="coffe", $quantity="1 unit"){ //1 takey deafult value dile onnotako dite hbe
   echo "\n{$quantity} {$foodType} is served ";
}

//type declaration or type hinting
function sum(int $x,int $y,int $z):int{//return type is declared here
    // return "abcd";
    return $x+$y+$z;
}