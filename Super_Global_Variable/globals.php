...
// Debugging: $GLOBALS can be useful for debugging your PHP code
// by allowing you to inspect the values of global variables from within a function or method.

// Configuration settings: You can use $GLOBALS to store configuration settings for your PHP application 
//that can be accessed from any part of your code. For example:
