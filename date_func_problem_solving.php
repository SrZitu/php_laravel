...
//Function to calculate the difference between two dates:(age calculator)
...
$date1 = '1997-01-01';
$date2 = '2023-01-01';
echo "\nDifference between $date1 and $date2 is: " . dateDiff($date1, $date2);

//Program to convert a string date into a timestamp:

$date = "2023-02-15";
$timestamp = strtotime($date);
echo "\nTimestamp for $date is: $timestamp";
...
$month = 2;
$year = 2023;
echo "\nNumber of days in month $month, year $year is: " . daysInMonth($month, $year);
...
echo "\nNew date after adding $daysToAdd days to $date is: $newDate";
...
$endDate = "2023-02-28";
echo "\nNumber of weekdays between $startDate and $endDate is: " . getWeekdays($startDate, $endDate);
echo PHP_EOL;
...
// Usage example
echo "Weeks left in current year:". getWeeksLeftInYear(); // Output: Number of weeks left in the current year
echo PHP_EOL;
...
// Usage example
echo "Days left in current year:". getDaysLeftInYear(); // Output:
echo PHP_EOL;
...
$timestamp = 1676937600; // February 21, 2022, 12:00:00 AM
...
// Examples:
echo getNextWeekday("Tuesday"); // Outputs the date of the next Monday
echo PHP_EOL;
