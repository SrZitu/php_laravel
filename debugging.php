...
Use var_dump(): 
=============
The var_dump() function in PHP is a powerful tool for debugging.
 It displays information about variables, including their type, value, and size.
*/ 
...
The error_log function in PHP is a way to log error messages and
 other information to a log file or to a system log, 
such as the syslog on Unix-based systems.This function is useful for debugging and for tracking problems that occur in your code.
*/ 
...
/*
debug_backtrace():
Use the debug_backtrace() function: The debug_backtrace() function in PHP can be used 
to print a backtrace of function calls.
The debug_backtrace() function in PHP is a powerful tool for debugging your code.
 It generates an array of information about the calls made to the functions in your script, 
 including the name of the function, the file it was called from, the line number, 
 and the arguments passed to the function. 
 This information can be used to trace the flow of control through your code and identify where problems are occurring.
*/ 
